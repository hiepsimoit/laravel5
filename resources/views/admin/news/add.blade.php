...
@section('content')
    ...
    <h1 class="text-uppercase">Thêm {{$title}} </h1>
    <!-- Content Header (Page header) -->

    <form id="form-action" class="form-horizontal" action="admin/'{{$url}}'/add" method="post">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <button id="btn-save" class="btn btn-primary btn-save" type="submit">Lưu</button>
            <div class="form-group">
                <div class="col-md-12">
